...
-- Toggle dap-ui
vim.keymap.set("n", "<C-d>u", function()
...
--Stage visual mode.
vim.keymap.set("v", "<C-h>s", function()
	gs.stage_hunk({ vim.fn.line("."), vim.fn.line("v") })
end, { desc = "Stage Hunk Visual" })

--Reset visual mode.
vim.keymap.set("v", "<C-h>r", function()
...
vim.keymap.set("n", "<C-h>b", function()
...
vim.keymap.set("n", "<C-h>D", function()
	gs.diffthis("~")
